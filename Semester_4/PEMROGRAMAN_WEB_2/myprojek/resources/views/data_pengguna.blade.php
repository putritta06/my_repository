...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">ACCIO WRITER HOUSE</a>
...
<div class="container-fluid">
  <div class="row">
    ...
    <a href="{{ route('dashboard.showDataPengguna') }}" class="btn" style="background-color: pink;"><b>Tambah Data</b></a>
